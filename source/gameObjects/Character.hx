	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				addOffset("danceLeft", -1000000, 100000);
				addOffset("danceRight", -1000000, 100000);
				playAnim('danceRight');
			...
			case 'bf-run':
				frames = Paths.getSparrowAtlas('characters/bf/CHAR bfRUN_2');

				animation.addByPrefix('idle', 'BFAnim_Idle0', 24, true);
				animation.addByPrefix('singUP', 'BFAnim_Up0', 24, false);
				animation.addByPrefix('singLEFT', 'BFAnim_Left0', 24, false);
				animation.addByPrefix('singRIGHT', 'BFAnim_Right0', 24, false);
				animation.addByPrefix('singDOWN', 'BFAnim_Down0', 24, false);

				addOffset("idle");
				addOffset("singUP", -46, 63);
				addOffset("singLEFT", 55, -6);
				addOffset("singRIGHT", -38, 33);
				addOffset("singDOWN",  -20, -21);
